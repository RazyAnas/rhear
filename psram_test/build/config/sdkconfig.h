...
#define CONFIG_SECURE_BOOT_IMAGE_DIGEST_LEN 32
#define CONFIG_SECURE_BOOT_ROM_FAST_WAKE_RESERVE_SIZE 0
...
#define CONFIG_ESP_HTTP_CLIENT_STRICT_HEADER_BUFFER 1
...
#define CONFIG_ESP_STDIO_MAX_VFS_ENTRIES 2
